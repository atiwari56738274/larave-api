...
class CoreJobTitleController extends Controller
{
    /**
    ...
    {
        try {
            $records = CoreJobTitle::select('uuid' ,'title', 'status')->orderBy('title', 'ASC');
    ...
    public function update(Request $request,$uuid)
    {
        try {
            ...
            $record = CoreJobTitle::where('uuid', $uuid)->first();
            if (!$record) {
