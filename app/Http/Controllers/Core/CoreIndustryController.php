...
class CoreIndustryController extends Controller
{
    ...
    {
        try {
            $records = CoreIndustry::select('id', 'uuid' ,'title', 'status')->orderBy('title', 'ASC');
    ...
    public function update(Request $request,$uuid)
    {
        try {
            ...
            $record = CoreIndustry::where('uuid', $uuid)->first();
            if (!$record) {
