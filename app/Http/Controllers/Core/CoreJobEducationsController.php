...
class CoreJobEducationsController extends Controller
{
    /**
    ...
    {
        try {
            $records = CoreJobEducations::select('uuid' ,'title', 'status')->orderBy('title', 'ASC');
     ...
     *
     * @param  \App\CoreJobEducations  $uuid
     * @return \Illuminate\Http\Response
     */
    ...
    public function update(Request $request,$uuid)
    {
        try {
            ...
            $record = CoreJobEducations::where('uuid', $uuid)->first();
            if (!$record) {
