...
class CoreJobSkillsController extends Controller
{
    /**
    ...
    {
        try {
            $records = CoreJobSkills::select('id', 'uuid' ,'title', 'status')->orderBy('title', 'ASC');
    ...
    public function update(Request $request,$uuid)
    {
        try {
            ...
            $record = CoreJobSkills::where('uuid', $uuid)->first();
            if (!$record) {
