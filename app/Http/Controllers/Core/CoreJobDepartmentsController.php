...
class CoreJobDepartmentsController extends Controller
{
    /**
    ...
    {
        try {
            $records = CoreJobDepartments::select('uuid' ,'title', 'status')->orderBy('title', 'ASC');
     ...
     *
     * @param  \App\CoreJobDepartments  $uuid
     * @return \Illuminate\Http\Response
     */
    ...
    public function update(Request $request,$uuid)
    {
        try {
            ...
            $record = CoreJobDepartments::where('uuid', $uuid)->first();
            if (!$record) {
