...
class CoreJobCityController extends Controller
{
    /**
    ...
    {
        try {
            $records = CoreJobCity::select('uuid' ,'title', 'status')->orderBy('title', 'ASC');
    ...
    public function update(Request $request,$uuid)
    {
        try {
            ...
            $record = CoreJobCity::where('uuid', $uuid)->first();
            if (!$record) {
